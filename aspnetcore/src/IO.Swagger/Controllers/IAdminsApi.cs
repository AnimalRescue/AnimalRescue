...
{ 
    ...
    /// 
    /// </summary>
    public interface IAdminsApiController
    { 
        /// <summary>
        /// adds a Building to the rescue
        /// </summary>
        /// <remarks>Adds a new Building to the Rescue</remarks>
        /// <param name="body">Building to add to the Rescue</param>
        /// <response code="200">ok</response>
        /// <response code="401">unauthorized request</response>
        IActionResult AddBuilding([FromBody]Building body);
        ...
        /// </summary>
        /// <remarks>Adds a new Enclosure to the Rescue</remarks>
        /// <param name="body">Enclosure to add to the Rescue</param>
        /// <response code="200">ok</response>
        /// <response code="401">unauthorized request</response>
        IActionResult AddEnclosure([FromBody]Enclosure body);
        ...
        /// </summary>
        /// <remarks>Adds a new Location to the Rescue</remarks>
        /// <param name="body">Location to add to the Rescue</param>
        /// <response code="200">ok</response>
        /// <response code="401">unauthorized request</response>
        IActionResult AddLocation([FromBody]Location body);
        ...
        /// </summary>
        /// <remarks>Deletes an existing Building by id</remarks>
        /// <param name="id"></param>
        /// <response code="200">ok</response>
        /// <response code="400">bad request</response>
        /// <response code="401">unauthorized request</response>
        IActionResult DeleteBuildingById([FromRoute][Required]Guid? id);
        ...
        /// </summary>
        /// <remarks>Deletes an existing Enclosure by id</remarks>
        /// <param name="id"></param>
        /// <response code="200">ok</response>
        /// <response code="400">bad request</response>
        /// <response code="401">unauthorized request</response>
        IActionResult DeleteEnclosureById([FromRoute][Required]Guid? id);
        ...
        /// </summary>
        /// <remarks>Deletes an existing Location by id</remarks>
        /// <param name="id"></param>
        /// <response code="200">ok</response>
        /// <response code="400">bad request</response>
        /// <response code="401">unauthorized request</response>
        IActionResult DeleteLocationById([FromRoute][Required]Guid? id);
        ...
        /// </summary>
        /// <remarks>Updates an existing Enclosure by id with only elements that are changing</remarks>
        ...
        /// <response code="200">ok</response>
        IActionResult PatchEnclosureById([FromBody]Enclosure body, [FromRoute][Required]Guid? id);
        ...
        /// <response code="200">ok</response>
        /// <response code="401">unauthorized request</response>
        IActionResult UpdateBuildingAtLocationById([FromBody]Building body, [FromRoute][Required]Guid? locationId, [FromRoute][Required]Guid? buildingId);

        /// <summary>
        /// updates a Building by id
        /// </summary>
        /// <remarks>Updates an existing Building by id</remarks>
        /// <param name="body">unique id of Building to update</param>
        /// <param name="id"></param>
        /// <response code="200">ok</response>
        /// <response code="401">unauthorized request</response>
        IActionResult UpdateBuildingById([FromBody]Building body, [FromRoute][Required]Guid? id);
        ...
        /// updates a Enclosure by id
        /// </summary>
        /// <remarks>Updates an existing Enclosure by id</remarks>
        /// <param name="body">unique id of Enclosure to update</param>
        /// <param name="id"></param>
        /// <response code="200">ok</response>
        /// <response code="401">unauthorized request</response>
        IActionResult UpdateEnclosureById([FromBody]Enclosure body, [FromRoute][Required]Guid? id);
