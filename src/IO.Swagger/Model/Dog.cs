...
namespace IO.Swagger.Model
{
        ...
        public partial class Dog :  IEquatable<Dog>
    {
        ...
        public Dog(BaseAnimalInfo baseInfo = default(BaseAnimalInfo), DogBreeds breed = default(DogBreeds), DogColors color = default(DogColors))
        {
            // to ensure "baseInfo" is required (not null)
            if (baseInfo == null)
            {
                throw new InvalidDataException("baseInfo is a required property for Dog and cannot be null");
            }
            else
            {
            ...
            if (breed == null)
            {
                throw new InvalidDataException("breed is a required property for Dog and cannot be null");
            }
            else
            {
                this.Breed = breed;
            ...
            if (color == null)
            {
                throw new InvalidDataException("color is a required property for Dog and cannot be null");
            }
            else
            {
                this.Color = color;
